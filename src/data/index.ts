export default [
  {
    _id: '1',
    name: 'ESP 6 String LTD Deluxe EC-1000T CTM Electric Guitar, See Thru Black Cherry, Right',
  ...
  {
    _id: '2',
    name: 'Pearl Roadshow Drum Set 4-Piece Complete Kit with Cymbals and Stands, Jet Black',
  ...
  {
    _id: '3',
    name: 'Neumann KMS 104 Handheld Vocal Condenser Microphone Matte Black',
  ...
  {
    _id: '4',
    name: 'Jackson JS Series Concert Bass JS2, Satin Black, Amaranth Fingerboard',
  ...
  {
    _id: '5',
    name: 'Sondery Metal Distortion Guitar Effect Pedal, Warm Smooth Wide Range of Vintage Distortion - True Bypass, 3 Modes of Solo Turbo and Normal - Mini Size, Art Design Series',
